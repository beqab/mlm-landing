...
import Bonus1 from "../../../imgs/bonus1.svg";
import Bonus2 from "../../../imgs/bonus2.svg";
...
const Bonus = () => {
  return (
    <>
      <div className="pageContainer pb-5 bonusPage ">
        <div className="container ">
          <div className="row">
            <div className="col-12 ">
              <h2 className="mt-0">Rank Advancement Bonuses</h2>
              <p>
                The Rank Advanced Bonuses was specially created for professional
                Affiliate Marketers and gives you the opportunity to have an
                extra income in the form of luxury goods. For each rank
                advancement you will receive the following prizes:
              </p>
            </div>
          </div>
      ...
      <div className="pageContainer bonusPage ">
        <div className="container ">
          ...
          <p style={{ fontSize: "20px" }} className="mt-3">
            In order to participate from this Rank Advancement Bonuses you need
            to have a personal Investment Status of a Founder.
          </p>
        </div>
      </div>
    </>
