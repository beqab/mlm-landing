    ...
    <div className="pageContainer Affiliate Locations">
      <div className="section11">
        <div className="container ">
          ...
          <div className="row">
            <div className="col-sm-12 mb-5 pb-12 img  ">
            ...
            <div className="col-sm-12 img mt-5 pt-5  ">
              ...
              <div className="row  mt-3 ">
                ...
                <div className="col-md-7">
                  <p className=" col-12 col-md-12 ">
                    ...
                    “pro-business” tax regulation. With our Bulgarian partners
                    we work together since 2018. <br /> Beside a very cannabis
                    friendly jurisdiction Bulgaria is offering cheap labor costs
                    and is therefore highly profitable for us. At the beginning
                    of our joint venture with this facility the total plantation
                    area was around 7.500 sqm. Since 2020 the total plantation
                    space we share with other business partners is around 15.000
                    sq. m. <br /> In Bulgaria we focus on raw CBD Flowers as
                    well as CBD Oil.
                  </p>
