...
const ResetPassword = ({ regAuthModal, setRegisterSuccessModal, setRegAuthModal, defaultValue }) => {
	const [ serverError, setServerError ] = React.useState({});
	const [ loading, setLoading ] = React.useState(false);
	const { register, handleSubmit, errors, setError, watch, clearError, getValues } = useForm();
	...
	return (
		...
		>
			{loading && (
				<img className="loader" src="https://cdn.dribbble.com/users/1028334/screenshots/2874977/canalol.gif" />
			)}
			...
			<div className="form-group">
				...
				{errors.mewPassword && (
					<div className="invalid-feedback">
						{' '}
						{errors.mewPassword.type === 'minLength' ? 'enter minimum 8' : 'password is required'}{' '}
					</div>
				)}
			</div>
			<div className="form-group">
